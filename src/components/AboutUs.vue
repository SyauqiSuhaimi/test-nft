<template>
  <div class="aboutUs">
      <div class="shadow-lg p-5 mb-5 bg-body rounded" style="max-width: 1200px; margin:30px auto">
          <h1>About Us</h1>
        ...
        <div class="row">
          <div class="col">
            ...
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" id="buttons">Protect Rainforest for 30 years USD100.00</button>
            </div>
            </div>
          </div>
          <div class="col">
            ...
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" id="buttons">Contribute to Keep It Green USD5.00</button>
            </div>
            </div>
          </div>
        </div>
